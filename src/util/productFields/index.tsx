...
export const defaultProductsList = [{
  label: 'tshirts',
  products: [
    {name: 'Camiseta preta', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/TShirts/CamisetaBrancaeMarrom/cam_bm_1.png','/e-commerce/assets/TShirts/CamisetaBrancaeMarrom/cam_bm_2.png','/e-commerce/assets/TShirts/CamisetaBrancaeMarrom/cam_bm_3.png','/e-commerce/assets/TShirts/CamisetaBrancaeMarrom/cam_bm_4.png','/e-commerce/assets/TShirts/CamisetaBrancaeMarrom/cam_bm_5.png','/e-commerce/assets/TShirts/CamisetaBrancaeMarrom/cam_bm_6.png', '/e-commerce/assets/TShirts/CamisetaBrancaeMarrom/cam_bm_7.png'], favorite: true, discount: 15, code: 6 },
    ...
    {name: 'Camiseta preta', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/TShirts/CamisetaVerde/cam_ver_1.png'], favorite: false, code: 10 },
    {name: 'Camiseta preta', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/TShirts/CamisetaVerde/cam_ver_1.png'], favorite: true, code: 11 }
  ]
}, 
{
  label: 'coats',
  products: [
    ...
    {name: 'Casaco preto', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Coats/BlusaPretaeBranca/blusa_pb_1.png'], favorite: false, code: 3 },
    {name: 'Casaco preto', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Coats/BlusaPreta/blusa_p_1.png'], favorite: false, code: 4 },
    {name: 'Casaco preto', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Coats/BlusaPretaeBranca/blusa_pb_1.png'], favorite: false, code: 5 },
  ]
},
{
  label: 'shorts',
  products: [
    ...
    {name: 'Bermuda preta', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Shorts/BermudaPreta/bermuda_p_1.png'], favorite: false, code: 13 },
    {name: 'Bermuda preta', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Shorts/BermudaPreta/bermuda_p_1.png'], favorite: false, code: 14 },
    {name: 'Bermuda preta', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Shorts/BermudaPreta/bermuda_p_1.png'], favorite: false, code: 15 },
    {name: 'Bermuda preta', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Shorts/BermudaPreta/bermuda_p_1.png'], favorite: false, code: 16 },
  ]
},
{
  label: 'pants',
  products: [
    ...
    {name: 'Calça preta', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Pants/CalcaPreta/calca_p_1.png'], favorite: true, code: 19},
    {name: 'Calça preta', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Pants/CalcaAzul/calca_az_1.png'], favorite: true, code: 20},
    {name: 'Calça preta', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Pants/CalcaPreta/calca_p_1.png'], favorite: true, code: 21},
    {name: 'Calça preta', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Pants/CalcaAzul/calca_az_1.png'], favorite: true, code: 22},
    {name: 'Calça preta', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Pants/CalcaPreta/calca_p_1.png'], favorite: true, code: 23}
  ]
},
{
  label: 'shoes',
  products: [
    ...
    {name: 'Tênis preto', collection: 'Basic', price: 199.99, images: ['/e-commerce/assets/Shoes/TenisBrancoPreto/tenis_bp_1.png','/e-commerce/assets/Shoes/TenisBrancoPreto/tenis_bp_2.png','/e-commerce/assets/Shoes/TenisBrancoPreto/tenis_bp_3.png','/e-commerce/assets/Shoes/TenisBrancoPreto/tenis_bp_4.png','/e-commerce/assets/Shoes/TenisBrancoPreto/tenis_bp_5.png'], favorite: false, code: 27 },
    {name: 'Tênis preto', collection: 'Basic', price: 199.99, images: ['/e-commerce/assets/Shoes/TenisPretoPadrao/tenis-preto.png', '/e-commerce/assets/Shoes/TenisPretoPadrao/atras.png', '/e-commerce/assets/Shoes/TenisPretoPadrao/baixo.png', '/e-commerce/assets/Shoes/TenisPretoPadrao/cima.png', '/e-commerce/assets/Shoes/TenisPretoPadrao/diagonal-direita.png', '/e-commerce/assets/Shoes/TenisPretoPadrao/frente.png', '/e-commerce/assets/Shoes/TenisPretoPadrao/lado.png'], favorite: false, code: 28 },
    {name: 'Tênis preto', collection: 'Basic', price: 199.99, images: ['/e-commerce/assets/Shoes/TenisBrancoPreto/tenis_bp_1.png','/e-commerce/assets/Shoes/TenisBrancoPreto/tenis_bp_2.png','/e-commerce/assets/Shoes/TenisBrancoPreto/tenis_bp_3.png','/e-commerce/assets/Shoes/TenisBrancoPreto/tenis_bp_4.png','/e-commerce/assets/Shoes/TenisBrancoPreto/tenis_bp_5.png'], favorite: false, code: 29 },
  ]
},
{
  label: 'accessories',
  products: [
    ...
    {name: 'Boné preto', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Accessories/BonePretoPeace/bone-peace-1.png'], favorite: true, code: 32 },
    {name: 'Boné preto', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Accessories/ShoulderCarteira/shoulder_c_1.png'], favorite: true, code: 33 },
    {name: 'Boné preto', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Accessories/BonePretoPeace/bone-peace-1.png'], favorite: true, code: 34 },
    {name: 'Boné preto', collection: 'Basic', price: 89.99, images: ['/e-commerce/assets/Accessories/ShoulderCarteira/shoulder_c_1.png'], favorite: true, code: 35 }
  ]
}
]
